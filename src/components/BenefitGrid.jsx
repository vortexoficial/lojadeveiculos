...
const benefits = [
  {
    ...
    desc: 'Suporte rápido e personalizado direto no seu celular, sem filas ou espera.',
  },
  {
    icon: <IcoDumbbell />,
    title: 'Produtos de alta performance',
    desc: 'Marcas selecionadas para quem leva o treino a sério e quer resultados reais.',
  },
  {
    icon: <IcoShirt />,
    title: 'Vestuário exclusivo',
    desc: 'Roupas desenvolvidas para treino intenso com design que representa sua força.',
  },
  {
    icon: <IcoTag />,
    title: 'Promoções frequentes',
    desc: 'Combos e ofertas reais para você economizar sem abrir mão da qualidade.',
  },
  {
    icon: <IcoBolt />,
    title: 'Compra simples e direta',
    desc: 'Sem checkout complicado. Escolha, chame no WhatsApp e receba com agilidade.',
  },
]
